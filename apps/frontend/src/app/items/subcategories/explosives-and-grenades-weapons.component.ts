...
export class ItemExplosivesAndGrenadesWeaponComponent implements AfterViewInit {
  public dataSourceWeapons = new MatTableDataSource<ItemWeapon>(
    Object.keys(allExplosivesAndGrenadesWeapons).map((key) => allExplosivesAndGrenadesWeapons[key])
  );
