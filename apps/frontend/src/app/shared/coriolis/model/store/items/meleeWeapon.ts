...
export const mace: ItemWeapon = new ItemWeapon({
  ...
  crit: 3,
  range: ItemRange.close,
  // itemFeatures: [ItemFeatures.heavyWeapon],
  techTier: ItemTechTier.primitive,
  cost: 100,
  baseSkill: GeneralSkillType.MeleeCombat,
});
export const powerSledge: ItemWeapon = new ItemWeapon({
  ...
  crit: 3,
  range: ItemRange.close,
  // itemFeatures: [ItemFeatures.heavyWeapon, ItemFeatures.cellPowered],
  techTier: ItemTechTier.ordinary,
  cost: 1000,
  baseSkill: GeneralSkillType.MeleeCombat,
});
export const powerGlove: ItemWeapon = new ItemWeapon({
  ...
  crit: 3,
  range: ItemRange.close,
  // itemFeatures: [ItemFeatures.lightWeapon, ItemFeatures.small, ItemFeatures.cellPowered],
  techTier: ItemTechTier.ordinary,
  cost: 1500,
  baseSkill: GeneralSkillType.MeleeCombat,
});
...
export const shockWhip: ItemWeapon = new ItemWeapon({
  ...
  crit: 0,
  range: ItemRange.close,
  // itemFeatures: [ItemFeatures.lightWeapon, ItemFeatures.small, ItemFeatures.flexible, ItemFeatures.stun, ItemFeatures.cellPowered],
  techTier: ItemTechTier.ordinary,
  cost: 800,
  baseSkill: GeneralSkillType.MeleeCombat,
});
export const energyStaff: ItemWeapon = new ItemWeapon({
  ...
  crit: 3,
  range: ItemRange.close,
  // itemFeatures: [ItemFeatures.stun, ItemFeatures.heavyWeapon, ItemFeatures.cellPowered],
  techTier: ItemTechTier.advanced,
  cost: 1000,
  baseSkill: GeneralSkillType.MeleeCombat,
});
...
export const brassKnuckles: ItemWeapon = new ItemWeapon({
  ...
  crit: 3,
  range: ItemRange.close,
  // itemFeatures: [ItemFeatures.lightWeapon, ItemFeatures.small],
  techTier: ItemTechTier.primitive,
  cost: 50,
  baseSkill: GeneralSkillType.MeleeCombat,
});
...
export const spear: ItemWeapon = new ItemWeapon({
  ...
  crit: 2,
  range: ItemRange.close,
  // itemFeatures: [ItemFeatures.longWeapon],
  techTier: ItemTechTier.primitive,
  cost: 200,
  baseSkill: GeneralSkillType.MeleeCombat,
});
